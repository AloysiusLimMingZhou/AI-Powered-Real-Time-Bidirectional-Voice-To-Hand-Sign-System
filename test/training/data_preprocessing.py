...
def load_dataset_from_npy(dataset_dir="sign_language_dataset_simple", expected_frames=60):
    """
...
if __name__ == "__main__":
    ...
    parser.add_argument("--dataset-dir", type=str, default="sign_language_dataset_simple", 
